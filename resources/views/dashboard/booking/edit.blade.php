                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.booking.index') }}">{{ __('models.edit_booking') }}</a>
                                    </li>
                                    {{-- <li class="breadcrumb-item"><a href="#">55</a>
                                    </li> --}}
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-vertical" id="updatesectorForm"
                                        action="{{ route('admin.booking.update', $booking->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select type="number" id="user_id" class="form-control"
                                                        ...
                                                        @foreach ($users as $user)
                                                            <option
                                                                value="{{ $user->id }}"{{ $user->id == $booking->user_id ? 'selected' : '' }}>
                                                                {{ $user->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('user_id')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select type="number" id="unit_id" class="form-control"
                                                            ...
                                                            @foreach ($units as $unit)
                                                                @if (App::getLocale() == 'ar')
                                                                    <option
                                                                        value="{{ $unit->id }}"{{ $unit->id == $booking->unit_id ? 'selected' : '' }}>
                                                                        {{ $unit->name_ar }}
                                                                    @else
                                                                    <option
                                                                        value="{{ $unit->id }}"{{ $unit->id == $booking->unit_id ? 'selected' : '' }}>
                                            ...
                                            @if ($booking->trip_id != null)
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="trip_id">{{ __('models.trip_name') }}</label>
                                                        <select type="number" id="trip_id" class="form-control"
                                                            name="trip_id">
                                                            @foreach ($trips as $trip)
                                                                @if (App::getLocale() == 'ar')
                                                                    <option
                                                                        value="{{ $trip->id }}"{{ $trip->id == $booking->trip_id ? 'selected' : '' }}>
                                                                        {{ $trip->name_ar }}
                                                                    @else
                                                                    <option
                                                                        value="{{ $trip->id }}"{{ $trip->id == $booking->trip_id ? 'selected' : '' }}>
