...
@section('title', __('models.add_offer'))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.add_offer') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.add_offer') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="createsectorForm"
                                        action="{{ route('admin.offers.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
