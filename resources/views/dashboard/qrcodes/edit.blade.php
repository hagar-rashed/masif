...
@section('title', __('models.edit_qrcode'))
                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">{{ __('models.edit_qrcode') }}</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">{{ __('models.edit_qrcode') }}</h2>
                            </div>
                            <div class="card-body">
                                <form class="form form-vertical" id="updateQRCodeForm"
                                    action="{{ route('admin.qrcodes.update', $qrcode->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="starting_date" class="form-control" name="starting_date" value="{{ old('starting_date', $qrcode->starting_date) }}" />
                                                @error('starting_date')
                                                    <span class="alert alert-danger">
                                                        <small class="errorTxt">{{ $message }}</small>
                                                    </span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="duration" id="duration" class="form-control" value="{{ old('duration', $qrcode->duration) }}" />
                                                @error('duration')
                                                <span class="alert alert-danger">
                                                    <small class="errorTxt">{{ $message }}</small>
                                                </span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select id="code_type" class="form-control" name="code_type">
                                                    <option value="guest" {{ old('code_type', $qrcode->code_type) == 'guest' ? 'selected' : '' }}>{{ __('models.guest') }}</option>
                                                    <option value="owner" {{ old('code_type', $qrcode->code_type) == 'owner' ? 'selected' : '' }}>{{ __('models.owner') }}</option>
                                                    <option value="rental" {{ old('code_type', $qrcode->code_type) == 'rental' ? 'selected' : '' }}>{{ __('models.rental') }}</option>
                                                </select>
                                                @error('code_type')
                                                    <span class="alert alert-danger">
                                                        <small class="errorTxt">{{ $message }}</small>
